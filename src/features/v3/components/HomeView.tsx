...
export function HomeView({ snapshot, onOpenNetwork }: { snapshot: V3Snapshot; onOpenNetwork(): void }) {
  ...
  return <section className="v3-home">
    ...
    <section className="v3-momentum-banner" aria-labelledby="v3-momentum-title">
      <div className="v3-momentum-orb" aria-hidden="true"><V3Icon name="sparkles" /></div>
      <div className="v3-momentum-copy">
        <p className="v3-eyebrow">UM PASSO DE CADA VEZ</p>
